...
tensorboard_folder = os.path.join(parent_dir, "RL_tensorboard_log")
experiment_folder = os.path.join(parent_dir, "RL_experiment_log")
result_csv_folder = os.path.join(parent_dir, "RL_result_CSV")
STATE_folder = os.path.join(result_csv_folder, "RL_state")
result_experiment = os.path.join(result_csv_folder, "RL_Experiment_Result")
daily_report_folder = os.path.join(result_csv_folder, "RL_daily_report")
